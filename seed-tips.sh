#!/bin/bash
# Script untuk seed tips data ke database

echo "🌱 Starting Tips Seed..."

# Tips data yang akan di-insert
TIPS_DATA='[
  {
...
# Insert tips menggunakan curl
for tip in $(echo $TIPS_DATA | jq -c '.[]'); do
  echo "Creating tip: $(echo $tip | jq -r '.judul')"
